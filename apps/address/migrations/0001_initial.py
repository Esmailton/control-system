...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('person', '0004_remove_city_uf_remove_uf_country_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='country_uf', to='address.country', verbose_name='Country')),
            ],
            options={
                'verbose_name': 'UF',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uf', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='uf_city', to='address.uf')),
            ],
            options={
                'verbose_name': 'City',
